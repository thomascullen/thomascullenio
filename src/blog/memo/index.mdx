...
it will skip rendering and resuse the last render unless the props change. Let's look at
an example.
...
If you open the web console you will notice in the example above every time we render the App
...
re-render by passing it a second argument. By default react will do a shallow comparison of all
...
propblem when using arrays and functions.
