...
Next up we are going to need a way to actually render some routes! Lets create
a `Routes` component to wrap our routes. ( This is following the newer
react-router API, think of it as the Switch component in the v5 API ).
